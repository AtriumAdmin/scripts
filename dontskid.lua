...
I made this script in a day, don't ask

The code is shit, mainly so you cant just skid it

I made this for the hub but wnated to make it open source cause why not :)
]]
IT = Instance.new
CF = CFrame.new
VT = Vector3.new
...
--Created using Nexo Animator, Yeah im old ik

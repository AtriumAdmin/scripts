{
    "NewsData": [
        ...
        [4, "@DIVIDER"],
        [5, "5/12: Ez Hub 4.3 has been released bringing the all new terminal to Ez Hub. Make sure to check it out!"]
    ],
    "StatusData": {
        "EzHub": "Online",
        "EzAPI": "Online",
    ...
    "LatestVersion": "https://raw.githubusercontent.com/AtriumAdmin/Atrium-Staff/main/AtriumStaff.lua",
    "Themes": {
        "Default": {
            "ThemeIndex": 1,
            "Primary": [41, 53, 68],

...
Domain.ButtonIcon.Image = "rbxassetid://1353544821"
...
Domain.Content.Text = "Atrium has found an exploit for this specific game."
...
Domain.Credits_2.Text = "Atrium V2"
...
Domain.Credits_3.Text = "Atrium V2"
...
Domain.Credits_4.Text = "Atrium V2"
...
Domain.About.Text = "Atrium: Version 1.1,"
...
Domain.About_2.Text = "Brought To You By Vexzy!"
...
Domain.About_3.Text = "Supported Games"
...
Domain.About_5.Text = "Base UI Made From Shlex UI Library"
...
Domain.Credits_5.Text = "Atrium V2"
...
Domain.Content_2.Text = "Welcome, Masterious."
...
Domain.VersionText.Text = "You're running Atrium version versoionnum"
...
Domain.text.Font = Enum.Font.GothamBold
Domain.text.Text = "Enjoying Atrium? Join our Discord for updates and news on the latest releases"
Domain.text.TextColor3 = Color3.fromRGB(255, 255, 255)
Domain.text.TextScaled = true
Domain.text.TextSize = 14.000
Domain.text.TextWrapped = true
...
Domain.link.Text = "https://discord.gg/5juCaNy76Z"
Domain.link.TextColor3 = Color3.fromRGB(255, 255, 255)
Domain.link.TextScaled = true
Domain.link.TextSize = 14.000
Domain.link.TextWrapped = true
...
Domain.ShlexLogo.Image = "rbxassetid://1353544821"
...
DiscordLink = "https://mboost.me/a/4Mr"
DomainPass = 3077897595
...
customtitles = {
	...
	[2] = {title="Atrium Owner",userids={3077897595}},
	[3] = {title="Atrium Owner",userids={3077897595}},
	[4] = {title="The longest fellow",userids={3077897595}},
	[5] = {title="This guy has a 2 incher",userids={3077897595}},
	[6] = {title="Fucked your mother hard",userids={3077897595}},
	[7] = {title="Got scammed",userids={3077897595}},
	[8] = {title="Gamer",userids={3077897595}},
	[9] = {title="Early Member",userids={581401336}},
	[10] = {title="13 inch penis",userids={419875084}},
...
UniversalExploits = {
	...
	CLOVR = {
		Name = "CloVR (R6 Only)",
		Author = "Abacaxl",
		Colour = Color3.fromRGB(85, 48, 127),
		Code = "https://pastebin.com/raw/4iTCQwHd",
	},
	expchat = {
		Name = "Exploiter Chat",
		Author = "Sheenieboy",
		Colour = Color3.fromRGB(48, 85, 200),
		Code = "https://raw.githubusercontent.com/sheenieboy/ExploiterChat/master/ExploiterChat",
	},
		unknownhub = {
		Name = "Unknown Hub V2",
		Author = "Unknow",
		Colour = Color3.fromRGB(85, 127, 85),
		Code = "https://paste.ee/r/wRN22",
	},
	cmdx = {
		Name = "CMD-X",
	...
	ultimatetrollui = {
		...
		Code = "https://raw.githubusercontent.com/AtriumAdmin/scripts/main/troll.lua",
	},
	InfiniteYield = {
		Name = "Infinite Yield",
		Author = "Edge",
	...
	dex = {
		...
		Author = "Moon",
		Colour = Color3.fromRGB(85, 48, 127),
		Code = "https://raw.githubusercontent.com/quentin452/CATIX-HUB/master/!DEX%20EXPLORER",	
	},
	simplespy = {
		Name = "SimpleSpy",
		Author = "ProtoSmasher",
		Colour = Color3.fromRGB(55, 95, 97),
		Code = "https://pastebin.com/raw/7GmZyarT",
	},
	atriumadminn = {
		Name = "Atrium Admin",
		Author = "Vexzy",
		Colour = Color3.fromRGB(55, 85, 127),
		Code = "https://raw.githubusercontent.com/AtriumAdmin/Atrium/main/main.lua",
	},
	ezhub = {
		Name = "EZHub",
		...
		for _, scrid in pairs(scr.PlaceIds) do
			if scrid == game.PlaceId then
				if scr.PremiumOnly == true then
					if game.Players.LocalPlayer:IsInGroup(11530887) then
						RePromptExploit(scr)
					end
				else
					RePromptExploit(scr)
...
local DefaultWidgets = {
	WidgetTest = {
		raw = "https://raw.githubusercontent.com/AtriumAdmin/Atrium-Staff/main/config.lua",
	}
}
...
function OpenAboutPlayer(Player)
	if Player then
		...
		if Player:IsInGroup(11530887) then
...
function GlitchTransition()
	...
	wait(0.3)
	Main.Visible = false
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/AtriumAdmin/Atrium-Staff/main/AtriumStaff.lua'),true))()
end
...
function BootDomain()
	...
	if DOMAIN_ENABLED == true then
		...
		Notify("Atrium Hub is in development, keep up to date in the Discord!","GothamBlack",Color3.fromRGB(0, 78, 115))
		wait(0.3)
		Notify("Running Atrium","GothamSemibold",Color3.fromRGB(154, 18, 222))
	...
	StartUnfunctionals()
		...
		if game.Players.LocalPlayer:IsInGroup(11530887) then
			...
			if theme and themedata and game.Players.LocalPlayer:IsInGroup(11530887) then
			...
			if startupsound and game.Players.LocalPlayer:IsInGroup(11530887) then
	...
	for _, Player in ipairs(game.Players:GetChildren()) do
		...
		booteddomain = "true"
		wait(4)
		Notify("UI Made By Shlex!","GothamBold",Color3.fromRGB(235, 0, 0))
		LoadPlayers()
	else
